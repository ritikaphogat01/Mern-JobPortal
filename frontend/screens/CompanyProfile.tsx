...
export const CompanyProfile: React.FC<CompanyProfileProps> = ({ onBack, onNavigate }) => {
  const companyInfo = {
      ...
      <div className="p-6 space-y-8">
        ...
        <section>
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={() => onNavigate(AppScreen.POST_JOB)} className="text-[10px] font-black text-primary uppercase">+ Post New</button>
          </div>
