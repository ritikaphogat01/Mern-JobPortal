    ...
    const fetchData = async () => {
      try {
        ...
        if (Array.isArray(appsData)) {
          ...
          const mapped = myApps.map((app: any) => {
            const jobId = app.jobId;
            const job = jobsData.find((j: any) => (j._id === jobId || j.id === jobId));
          ...
          const sorted = [...mapped].sort((a: any, b: any) => new Date(b.date).getTime() - new Date(a.date).getTime());
