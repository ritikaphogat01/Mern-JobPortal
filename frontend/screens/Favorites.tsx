...
export const Favorites: React.FC<FavoritesProps> = ({ onSelectJob, onBack, favorites, onToggleFavorite, onShare, jobs }) => {
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[11px] font-bold text-accent">
                      {applicantCounts[job.id || (job as any)._id] > 0
                        ? `Trending • ${applicantCounts[job.id || (job as any)._id]} Applied`
