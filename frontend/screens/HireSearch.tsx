...
interface HireSearchProps {
  ...
  onPostJob: (category: string, subCategory: string) => void;
  onBack: () => void;
}

export const HireSearch: React.FC<HireSearchProps> = ({ initialCategory, onPostJob, onBack }) => {
    ...
    <div className="animate-fade-in bg-white min-h-screen pb-32">
      ...
      <div className="divide-y divide-gray-50">
        {loading ? (
          ...
          (selectedCategory ? (activeCat?.subCategories || []) : categories).map((item: any) => (
            <button
